...
urlpatterns = [
    ...
    path('cadastrar-vendedora/', views.cadastrar_vendedora, name='cadastrar_vendedora'),
    ...
    path('cadastrar-loja/', views.cadastrar_loja, name='cadastrar_loja'),
    path('listar-lojas/', views.listar_lojas, name='listar_lojas'), 
    ...
    path("metas/adicionar/vendedora/", views.adicionar_meta, name="adicionar_meta_vendedora"),
    path("metas/editar/<int:meta_id>/", views.editar_meta, name="editar_meta"),
    path("metas/editar/vendedora/<int:meta_id>/<int:vendedora_id>/", views.editar_meta, name="editar_meta_vendedora"), 
    path("metas/excluir/<int:meta_id>/", views.excluir_meta, name="excluir_meta"),
    path("metas/excluir/vendedora/<int:meta_id>/<int:vendedora_id>/", views.excluir_meta, name="excluir_meta_vendedora"),
    ...
    path("exportar-excel/", views.exportar_excel_relatorio, name="exportar_excel"),
